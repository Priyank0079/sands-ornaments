...
export const SKUS = [
    { id: 'sku_1', name: 'Gold Necklace 22k', unit: 'pc', price: 45000, category: 'Chain Pendant' },
    ...
    { id: 'sku_4', name: 'Gold Bracelets Set', unit: 'set', price: 35000, category: 'Bracelets' },
    ...
    { id: 'sku_7', name: 'Studs Gold', unit: 'pc', price: 800, category: 'Studs' },
...
export const PRODUCTS = [
    ...
    },
    {
        ...
        name: 'Antique Gold Temple Bracelets',
        category: 'Bracelets',
        subcategory: 'Temple Jewellery',
        rating: 4.7,
        tag: 'WEDDING',
        image: banglesUrl,
        description: 'Stunning antique finish gold bracelets featuring intricate carvings of goddesses and floral motifs. Perfect for weddings and traditional ceremonies.',
