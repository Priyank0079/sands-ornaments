...
export const homeCategoryGridDefaults = [
    ...
    { id: 'bracelets', name: 'Bracelets', image: braceletsImg, path: '/category/bracelets' },
    { id: 'pendants', name: 'Pendants', image: pendantsImg, path: '/category/necklaces' },
    { id: 'earrings', name: 'Earrings', image: earringsImg, path: '/category/earrings' },
    { id: 'men-in-silver', name: 'Men in Silver', image: mensilverImg, path: '/category/men' },
    { id: 'sets', name: 'Sets', image: setsImg, path: '/category/sets' },
    { id: 'anklets', name: 'Anklets', image: ankletsImg, path: '/category/anklets' },
    { id: 'silver-chains', name: 'Silver Chains', image: silverchainsImg, path: '/category/chains' },
    { id: 'mangalsutras', name: 'Mangalsutras', image: mangalsutraImg, path: '/category/mangalsutras' },
    { id: 'nose-pins', name: 'Nose Pins', image: nosepinImg, path: '/category/nose-pins' },
    { id: 'personalised', name: 'Personalised', image: personalisedImg, path: '/category/personalised' },
    { id: 'bangles', name: 'Bangles', image: bangleImg, path: '/category/bangle' },
