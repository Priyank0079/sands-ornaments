...
const AccordionItem = ({ title, children, isOpen, onClick }) => (
  <div className="border-b border-[#EBCDD0]/50">
    ...
    >
      ...
      >
        <ChevronDown
          className={`w-5 h-5 ${isOpen ? "text-[#D39A9F]" : "text-gray-400 group-hover:text-[#D39A9F]"}`}
        />
      </span>
    </button>
    <div
      ...
      const suffix =
        materialLower === "gold"
          ...
          : materialLower === "silver"
            ? "Silver Jewellery"
            : "Jewellery";
      document.title = `${product.name} | Sands Jewels - ${suffix}`;
    }
  }, [product, track]);
    ...
    <div className="bg-white min-h-screen py-8 pb-24 md:pb-8 animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out fill-mode-both selection:bg-[#D39A9F] selection:text-white">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div className="h-[400px] lg:h-[520px] w-full bg-white rounded-[2rem] border border-gray-100 p-6 md:p-10 shadow-sm relative flex flex-col">
            ...
            >
              <h2 className="text-xl font-bold text-center text-gray-900 mb-6 tracking-tight">
                Jewellery Details
              </h2>
              ...
              >
                {activeDetailTab === "details" ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {hasDiamonds && (
                      <div className="bg-white rounded-3xl p-8 border border-[#8E2B45]/10 shadow-[0_4px_20px_-4px_rgba(142,43,69,0.05)] flex flex-col items-center text-center">
                        ...
                        <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-[#8E2B45] mb-10 border-b border-[#8E2B45]/10 pb-2">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-10 gap-x-6 w-full">
                          <div className="group transition-all duration-300">
                            ...
                            <span className="text-[13px] font-bold text-gray-900 block capitalize">
                    ...
                    <div
                      className={`${hasDiamonds ? "" : "md:col-span-2 max-w-lg mx-auto w-full"} bg-gray-50 rounded-2xl p-6 border border-gray-100 flex flex-col items-center text-center`}
                    >
                      ...
                      <div className="grid grid-cols-2 gap-y-6 gap-x-8 w-full">
                        ...
                        <div className="space-y-1">
                          ...
                          <span className="text-xs font-semibold text-emerald-700 block uppercase tracking-tighter">
                            {product.huid || "SANDS-AUTH"}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
                      ...
                      <table className="w-full text-left border-collapse">
                          ...
                          {[
                            {
                              ...
                              rate: `${selectedVariantWeight || product.weight || "---"} g`,
                            ...
                            >
                              <td className="px-6 py-4 text-[11px] font-bold text-gray-700 uppercase tracking-tight">
                                {item.label}
                              </td>
                              <td className="px-6 py-4 text-[11px] font-semibold text-gray-500 text-right">
                                {item.rate}
                              </td>
                              <td className="px-6 py-4 text-[11px] font-bold text-gray-900 text-right">
                        ...
                        <tfoot>
                          <tr className="bg-[#8E2B45]/5 border-t border-[#8E2B45]/10">
                            <td
                              colSpan="2"
                              className="px-6 py-5 text-[11px] font-black text-[#8E2B45] uppercase tracking-[0.2em]"
                            >
                              Total Price
                            </td>
                            <td className="px-6 py-5 text-lg font-black text-[#8E2B45] text-right">
                              {formatCurrency(
                    ...
                    <p className="mt-4 text-[9px] text-gray-400 text-center font-bold uppercase tracking-widest italic">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-200 p-3 z-[150] md:hidden flex gap-3 shadow-[0_-10px_30px_rgba(0,0,0,0.1)] pb-safe animate-in slide-in-from-bottom duration-500">
        <div className="flex flex-col justify-center px-2">
          <span className="text-[8px] uppercase tracking-wider text-gray-400 font-bold mb-0.5">
            Total
          </span>
      ...
      <div className="container mx-auto px-4 mt-4 mb-10 max-w-4xl">
        <div className="bg-white border border-gray-100 rounded-xl p-3 flex flex-col md:flex-row items-center gap-4 shadow-sm relative overflow-hidden group">
          ...
          <div className="flex items-center gap-2 pl-2">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-500 hidden lg:block whitespace-nowrap">
                    ...
                    <div className="bg-[#FDFBF7] rounded-2xl p-6 border border-[#F5E6D3]/30">
                      <div className="space-y-4">
                        <div className="flex justify-between items-center text-xs font-medium text-gray-600">
                          <span>
                            Metal Price (
                            {currentVariant?.weight || product.weight || "0"}{" "}
                            {currentVariant?.weightUnit ||
                              product.weightUnit ||
                              "g"}
                            )
                          </span>
                        ...
                        <div className="pt-4 border-t border-[#F5E6D3]/50 flex justify-between items-center">
                          <span className="text-xs font-black text-[#8E2B45] uppercase tracking-widest">
                            Subtotal (Pre-Tax)
                          </span>
                          <span className="text-sm font-black text-[#8E2B45]">
                  ...
                  <div className="py-4">
                    {product.stylingTips ? (
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: sanitizeHtml(product.stylingTips),
                        }}
                      />
                    ) : (
      ...
      {galleryImages.length > 0 && (
        <div className="mt-12 mb-20 px-4 max-w-6xl mx-auto">
          <div className="flex flex-col items-center mb-10">
            <span className="text-[9px] font-bold text-[#D39A9F] uppercase tracking-[0.4em] mb-2">
              Style Showcase
            </span>
        ...
        <div className="fixed inset-0 bg-black/60 z-[200] flex items-center justify-center p-4 backdrop-blur-md animate-in fade-in duration-300">
          <div className="bg-white rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 max-h-[90vh] flex flex-col">
            ...
            <div className="p-8 overflow-y-auto space-y-10 custom-scrollbar">
              ...
              <div className="space-y-6">
                <h4 className="text-2xl font-bold text-gray-900 leading-tight">
                  Why Choose Sands Lab-Grown Diamonds?
                </h4>
        ...
        <div className="bg-[#FDFBF7] border-t border-gray-100 py-20 mt-10 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-[#8E2B45] uppercase tracking-[0.4em] mb-3">
                  Elevate Your Set
                </span>
                ...
                <div key={relProduct._id || relProduct.id} className="group">
                  ...
                  <div className="mt-4 flex justify-between items-start">
                    <div className="min-w-0 flex-1 pr-2">
                      <h3 className="text-[10px] font-bold text-gray-800 uppercase tracking-widest line-clamp-1">
                        {relProduct.name}
                      </h3>
                      <p className="text-[10px] font-black text-[#8E2B45] mt-1">
          ...
          <div className="bg-white w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            <div className="bg-[#8E2B45] p-8 text-white relative">
              ...
              <p className="text-[10px] font-bold text-white/50 uppercase tracking-[0.2em]">
                Find your perfect fit with Sands Jewels
              </p>
              <button
                        ...
                        <tbody className="divide-y divide-gray-100">
                          {[
                            ...
                            <tr key={i} className="hover:bg-white">
                              <td className="px-4 py-2 font-black text-[#8E2B45]">
                                {row.s}
                              </td>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        >
                          <span className="text-sm font-black text-[#8E2B45]/10 group-hover:text-[#8E2B45]/30 transition-colors">
                            {item.step}
                          </span>
