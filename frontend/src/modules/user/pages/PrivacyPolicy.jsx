...
const PrivacyPolicy = () => {
  ...
  const policies = [
    ...
    },
    {
      ...
      content:
        "Your payment details are encrypted and processed by Razorpay. Sands Jewels does not store your credit card or bank credentials on our servers.",
    },
    {
    ...
    <div className="bg-white min-h-screen py-8 md:py-20 selection:bg-[#D39A9F] selection:text-white">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12 md:mb-20">
          <span className="text-[#D39A9F] text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] mb-3 block">
            Your Privacy Matters
          </span>
          <h1 className="text-4xl md:text-6xl font-display text-black mb-6">
            Privacy Policy
          </h1>
          <div className="w-16 md:w-24 h-0.5 bg-[#EBCDD0] mx-auto mb-6"></div>
          <p className="text-gray-400 text-xs md:text-sm font-serif italic">
        ...
        <div className="bg-white rounded-[2rem] p-6 md:p-12 shadow-sm border border-[#F3F4F6]">
          <div className="flex items-center gap-4 mb-10 md:mb-16 p-6 bg-gray-50 rounded-2xl border border-[#F3F4F6]">
            ...
            <p className="text-sm md:text-base font-serif text-gray-600 italic">
              "Sands Jewels is committed to ensuring that your privacy is
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {policies.map((policy, idx) => (
              <div
                key={idx}
                className="p-6 md:p-8 rounded-2xl border border-[#F3F4F6] hover:shadow-md transition-all hover:border-[#EBCDD0] group bg-white"
              >
                <div className="text-black mb-4 bg-gray-50 w-fit p-3 rounded-xl group-hover:bg-[#EBCDD0] transition-colors">
                  {policy.icon}
                </div>
                <h3 className="text-lg md:text-xl font-display text-black mb-3">
                  {policy.title}
                </h3>
          ...
          <div className="mt-12 md:mt-20 border-t border-[#F3F4F6] pt-10 md:pt-16">
            <h4 className="font-display text-black mb-4 md:mb-6 text-lg md:text-xl">
