...
// Using existing assets for categories
...
const LAUNCH_CATEGORIES = [
    ...
    { id: 3, name: 'Personalised', image: personalisedImg, path: '/category/personalised' },
    { id: 4, name: 'Earrings', image: earringsImg, path: '/category/earrings' },
    { id: 5, name: 'Pendants', image: pendantsImg, path: '/category/necklaces' },
    { id: 6, name: 'Mens', image: mensilverImg, path: '/category/men' },
    { id: 7, name: 'Perfumes', image: setsImg, path: '/category/perfumes' }, // Placeholder for Perfumes
    { id: 8, name: 'Sets', image: setsImg, path: '/category/sets' },
    { id: 9, name: 'Anklets', image: ankletsImg, path: '/category/anklets' }
];
    ...
    return (
        <section className="w-full bg-[#D1C7CB] mt-4 md:mt-6 py-4 md:py-5 overflow-hidden font-sans">
            <div className="container mx-auto px-4 max-w-[1450px]">
                ...
                {/* Same-to-Same Header: Compacted */}
                <div className="flex flex-row items-center justify-center mb-5 gap-4 md:gap-6">
                    
                    {/* Ribbon Flag - Dark Maroon */}
                    <div className="shrink-0">
                        <div className="bg-[#5C1B33] text-white px-7 md:px-10 py-2.5 md:py-3 font-bold text-base md:text-xl tracking-normal uppercase relative z-10" 
                             style={{ 
                ...
                {/* Horizontal Scroll Grid - Compacted Gaps */}
                <div 
                    ref={scrollRef}
                ...
                >
                    {LAUNCH_CATEGORIES.map((cat) => (
                        ...
                        >
                            {/* Stadium/Super-Rounded Card Shape */}
                            <div className="relative w-[110px] h-[110px] md:w-[155px] md:h-[155px] mb-3 overflow-hidden rounded-[35px] md:rounded-[50px] shadow-[0_10px_20px_rgba(0,0,0,0.12)]">
                                ...
                                <div className="absolute top-0 left-1/2 -translate-x-1/2 z-20">
                                    <div className="bg-[#8C5D62]/60 backdrop-blur-md px-4 md:px-6 py-0.5 md:py-1 rounded-b-2xl md:rounded-b-3xl flex items-center justify-center gap-1 border border-white/10 shadow-sm">
                                        ...
                                        <span className="text-white text-[9px] md:text-[11px] font-bold leading-none">New</span>
                                    </div>
                                </div>
                            </div>
