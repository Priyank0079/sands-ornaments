            ...
            <div className="container mx-auto px-4 max-w-[1250px]">
                <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                    ...
                    >
                        ...
                        <div 
                            onClick={() => navigate('/shop?price_lte=999')}
                    ...
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-8 w-full">
                        ...
                        <motion.div
                            ...
                            className="w-full"
                        >
                            <div onClick={() => navigate('/shop?price_lte=1499')} className="group cursor-pointer relative block w-full aspect-[16/9.5] overflow-hidden rounded-[32px] shadow-sm hover:shadow-xl transition-all duration-500">
                                <img 
                                    src={budgetEarrings} 
                                    alt="Luxury Earrings" 
                        ...
                        <motion.div
                            ...
                            className="w-full"
                        >
                            <div onClick={() => navigate('/shop?price_lte=1999')} className="group cursor-pointer relative block w-full aspect-[16/9.5] overflow-hidden rounded-[32px] shadow-sm hover:shadow-xl transition-all duration-500">
                                <img 
                                    src={budgetPendant} 
                                    alt="Luxury Pendant" 
                                    className="w-full h-full object-cover transition-transform duration-[2000ms] group-hover:scale-110" 
