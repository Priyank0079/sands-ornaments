    ...
    const displayItems = configuredItems.length > 0
        ? configuredItems.map((item, index) => {
            ...
            return {
                ...
                subtitle: item.subtitle || (item.priceMax ? `Under ₹${item.priceMax}` : (isFirst ? 'Elegant Finds' : 'Premium Picks')),
                        ...
                        >
                            ...
                            <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-center">
                                <div className="transform transition-transform duration-700 group-hover:translate-x-3">
                                    ...
                                    <p className="text-white/90 text-sm md:text-xl font-medium tracking-widest uppercase">
                                        {item.subtitle}
                                    </p>
                                </div>
                            </div>
