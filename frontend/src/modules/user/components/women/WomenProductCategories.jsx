        ...
        <section className="py-24 px-4 md:px-12 bg-white">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-20">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-serif text-[#7A2E3A] tracking-tight">
                            Shop by Category
                        </h2>
                        <p className="text-zinc-500 font-light text-sm md:text-base max-w-2xl mx-auto px-4 leading-relaxed">
                            Discover our handcrafted silver masterpieces, each piece telling a unique story of timeless elegance.
                        </p>
                        <div className="w-16 h-[1px] bg-[#7A2E3A]/20 mt-4" />
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-8 md:gap-12">
                    {categories.map((category, index) => (
                        ...
                        >
                            <Link 
                                to={category.path}
                                className="relative block w-full aspect-square rounded-[2.5rem] overflow-hidden bg-zinc-50 shadow-sm border border-zinc-100 transition-all duration-500 hover:shadow-xl hover:-translate-y-2"
                            >
                                <img 
                                    src={category.image} 
                                    alt={category.title}
                            ...
                            <div className="mt-6 text-center">
                                <h3 className="text-[#333333] font-serif text-lg md:text-xl transition-colors duration-300 group-hover:text-[#7A2E3A]">
