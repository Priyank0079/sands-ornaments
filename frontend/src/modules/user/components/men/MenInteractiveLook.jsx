        ...
        <section className="py-16 md:py-24 bg-[#FCFBF8]">
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="text-center mb-8 md:mb-14">
                    <h2 className="text-3xl md:text-4xl font-black text-[#111] uppercase tracking-wide mb-2">
                        Shop The Look
                    </h2>
                    <div className="w-16 h-1.5 bg-[#3B82F6] mx-auto rounded-full mb-4"></div>
                    <p className="text-gray-500 text-sm md:text-base tracking-[0.2em] uppercase">
                        Complete Your Signature Style
                    </p>
                </div>

                {/* Interactive Diagram Container */}
                <div className="max-w-[1000px] mx-auto relative rounded-[40px] shadow-2xl overflow-hidden bg-[#0A0B0D] h-[600px] md:h-[800px]">
