...
const MenFeaturedProductsEditor = ({ sectionData, onSave, defaultSection = {} }) => {
    ...
    const initialSettings = useMemo(() => {
        ...
        const categoryHint = current.categoryId
            ...
            || '';
        return {
            title: current.title || fallback.title || "Men's Exclusive",
            ...
            ctaLabel: current.ctaLabel || fallback.ctaLabel || 'View All Collection'
        };
    ...
    const handleSave = async () => {
        ...
        try {
            await onSave({
                settings: {
                    title: String(settings.title || '').trim() || "Men's Exclusive",
                    productLimit,
                    sourceMode,
    ...
    return (
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 md:px-8 py-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h3 className="text-xl md:text-2xl font-bold text-[#3E2723]">Men&apos;s Exclusive</h3>
                    <p className="text-sm text-gray-500 mt-1">
                        Configure this section from CMS. Products are always rendered men-only on user side.
                    </p>
                </div>
                <button
                    type="button"
            ...
            <div className="p-6 md:p-8 space-y-5">
                ...
                <div className="rounded-xl border border-gray-100 bg-[#FCFCFC] px-4 py-3">
                    <p className="text-xs text-gray-500">
                        User-side button is fixed to <span className="font-semibold text-[#3E2723]">View All Collection</span> and opens all men products.
                    </p>
                </div>
            </div>
...
export default MenFeaturedProductsEditor;
