...
const homeSections = [
  {
    ...
    items: [
      ...
      {
        id: "hero-3",
        name: "Handcrafted Silver",
        label: "Sterling Silver Heritage",
        subtitle: "Timeless craftsmanship meets modern architectural design.",
        image: silverHeroDefault,
        path: "/shop",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        rating: 5,
        description:
          "Bought a bracelet for my sister's birthday. She absolutely loved it! The shine is perfect, and the delivery was very fast. Highly recommend Sands Jewels for quality silver.",
        location: "Delhi",
      },
      {
        id: "testimonial-3",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        rating: 5,
        description:
          "Most gold rings for men look dated. I wanted to gift him something that matches the wedding ring he got me too. Finally got to know SANDS' gold made-to-order option.",
        location: "Mumbai",
      },
      {
