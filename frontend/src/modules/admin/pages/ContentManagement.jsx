...
const ContentManagement = () => {
  ...
  const [aboutContent, setAboutContent] = useState({
    heroTitle: "About Us",
    heroSubtitle:
      "Welcome to Sands Jewels, where elegance meets timeless tradition. We are more than just a jewellery brand; we are curators of silver artistry designed to adorn your soul.",
    mainStory:
    ...
    missionStatement:
      "At Sands Jewels, we are committed to sustainability and ethical sourcing, ensuring that beauty does not come at a cost to our planet.",
    images: [
      {
        id: 1,
