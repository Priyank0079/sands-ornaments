...
import { Phone, Mail, Clock, HelpCircle, ArrowLeft, ArrowRight, ShieldCheck, ShoppingBag, Percent, Wallet, Key } from 'lucide-react';
    ...
    const merchantFaqs = [
        {
            ...
            answer: "Upon completing registration, our administration team reviews your business credentials (including GSTIN, PAN, and Bank details). Verification typically takes 24–48 business hours. You will receive an SMS and email notification once your account status is set to APPROVED."
        },
        {
            icon: <ShoppingBag className="w-5 h-5 text-[#3E2723]" />,
            question: "How do I add and manage my products?",
            answer: "Once approved, log in to the Seller Gateway and click on 'Products' in the sidebar. You can create new products, set pricing, adjust inventory levels, manage variant attributes, and view product barcodes."
        },
        {
            icon: <Percent className="w-5 h-5 text-[#3E2723]" />,
            question: "How is my seller commission calculated?",
            answer: "Commissions are processed based on the commission tier assigned to your profile by the admin. You can track your sales, commission rates, and real-time accruals in the 'Commission' section of your dashboard."
        },
        {
            icon: <Wallet className="w-5 h-5 text-[#3E2723]" />,
            question: "When and how are payouts processed?",
            answer: "Weekly payouts are initiated directly to your registered bank account for all completed orders. You can request manually triggered payouts or monitor transaction logs from the 'Wallet' tab."
        },
        {
            icon: <Key className="w-5 h-5 text-[#3E2723]" />,
            question: "What should I do if I cannot log in or forgot my password?",
            answer: "If you cannot log in, navigate to the Seller Login gateway and click on the 'Forgot Password' link. You can reset your password using a verified mobile number SMS OTP or email verification."
        }
    ];
    ...
    return (
        <div className="min-h-screen bg-[#FDF5F6] text-gray-900 font-sans pb-16 selection:bg-[#3E2723] selection:text-white">
            ...
            <div className="container mx-auto px-6 py-6 flex items-center justify-between border-b border-[#3E2723]/5">
                ...
                <span className="text-xs font-black uppercase tracking-[0.2em] text-[#3E2723]">Sands Ornaments</span>
            </div>

            {/* Hero Section */}
            <div className="max-w-4xl mx-auto text-center px-6 pt-16 pb-12 relative overflow-hidden">
                <span className="text-[#3E2723]/60 text-[10px] md:text-xs font-bold uppercase tracking-[0.25em] mb-3 block">Seller gateway</span>
                ...
                <p className="text-gray-500 font-serif text-sm md:text-base max-w-xl mx-auto leading-relaxed">
                    Welcome to the Sands Ornaments Seller Help Center. Find information on account setup, listing products, tracking sales commissions, and setting up payouts.
                </p>
            </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-[#3E2723] text-white p-8 rounded-[2rem] shadow-xl space-y-6">
                        ...
                        <p className="text-white/75 text-xs md:text-sm leading-relaxed font-serif">
                            Access your inventory tools, check your sales metrics, or register a new merchant account.
                        </p>
                    ...
                    <div className="bg-white p-8 rounded-[2rem] border border-[#3E2723]/5 shadow-sm space-y-6">
                        <h3 className="text-lg font-display font-bold text-black uppercase tracking-tight">Direct Support Channels</h3>
                        <p className="text-gray-500 text-xs leading-relaxed font-serif">
                            Need direct support regarding commission disputes or banking updates? Contact our admin team:
                        </p>
                        <div className="space-y-4 pt-2">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-gray-400 text-[9px] uppercase tracking-widest font-black">Hours of Operation</p>
                                    <p className="text-xs md:text-sm font-bold text-black">Mon–Sat, 10 AM–7 PM IST</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="text-sm md:text-base font-bold text-black">{faq.question}</h4>
                                        <p className="text-xs md:text-sm text-gray-500 leading-relaxed font-serif">{faq.answer}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
